                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Ubah data akun <span className="font-semibold text-gray-700">{user.name}</span></p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <div className="card overflow-hidden">
                        ...
                        <div className="px-6 py-3 border-t border-b border-gray-100 bg-gray-50">
                            <div>
                                <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wider">Ganti Kata Sandi</h3>
                                <p className="text-xs text-gray-500 mt-0.5">Kosongkan jika tidak ingin mengganti kata sandi</p>
                            </div>
                        </div>
