...
import { UserPlus, ArrowLeft, User, Mail, Lock, Shield, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">Buat akun baru untuk pengguna produk</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-lg overflow-hidden">
                        ...
                        <div className="px-6 pt-4 pb-4 border-t border-b border-white/10">
                            <h3 className="text-sm font-semibold text-slate-300 uppercase tracking-wider">Kata Sandi</h3>
                        </div>
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            {/* Password */}
                            <div>
                                <InputLabel htmlFor="password" value="Kata Sandi" className="text-slate-300 mb-1.5" />
                                <div className="relative">
                                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                            ...
                            <div>
                                <InputLabel htmlFor="password_confirmation" value="Konfirmasi Kata Sandi" className="text-slate-300 mb-1.5" />
                                <div className="relative">
                                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                        <Lock className="h-4 w-4 text-slate-500" />
                                    </div>
                        ...
                        <div className="px-6 py-4 bg-white/[0.02] border-t border-white/10 flex items-center justify-end gap-3">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex items-center gap-2 px-5 py-2 rounded-xl bg-indigo-600 text-sm font-medium text-white hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/20"
                            >
                                {processing ? (
